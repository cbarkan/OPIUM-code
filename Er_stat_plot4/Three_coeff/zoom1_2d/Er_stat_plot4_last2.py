...
coeff_vector = np.array([-4.0,0.0,0.0])

#Here, c0 is second to last coeff, and c1 is last coeff
c0_lower_bound = -10.0
c0_upper_bound = -6.0
c1_lower_bound = -6.00
c1_upper_bound = -2.0
...
for c0 in range(int((c0_upper_bound - c0_lower_bound)/mesh_step)):
    coeff_vector[-2] = c0*mesh_step + c0_lower_bound
