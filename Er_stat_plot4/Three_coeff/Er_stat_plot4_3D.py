...
coeff_vector = np.array([0.0,0.0,0.0])
...
num_trials = coeff0_trials*coeff1_trials*coeff2_trials

Eig1_mesh = np.zeros((coeff0_trials,coeff1_trials,coeff2_trials))
...
DD_mesh = np.ones((coeff0_trials,coeff1_trials,coeff2_trials,(tconfig_num*(tconfig_num+1)/2)))
...
for c0 in range(coeff0_trials):
    ...
    for c1 in range(coeff1_trials):
        ...
        for c2 in range(coeff2_trials):
            ...
            Eig1_mesh[c0,c1,c2] = Er_eig1
            Norm1_mesh[c0,c1,c2] = Er_norm1
            Eig2_mesh[c0,c1,c2] = Er_eig2
            Norm2_mesh[c0,c1,c2] = Er_norm2
            Eig3_mesh[c0,c1,c2] = Er_eig3
            Norm3_mesh[c0,c1,c2] = Er_norm3
            Eig4_mesh[c0,c1,c2] = Er_eig4
            Norm4_mesh[c0,c1,c2] = Er_norm4
            Eig5_mesh[c0,c1,c2] = Er_eig5
            Norm5_mesh[c0,c1,c2] = Er_norm5
            DD_mesh[c0,c1,c2,:] = DD
            current_trial += 1
