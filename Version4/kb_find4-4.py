...
def alpha_find(coeff_vector,alpha_step):
    ...
    if ErU < ErmL:
        ...
        count = 0
        while alpha_step >= 0.001*slopeCheckAlpha/slope_length:
            aU = aU/4
            ...
            if ErU < ErmL:
                ...
                print 'No alpha found: returning alpha = 0'
...
def path_plot():
    ...
    fig = plt.figure()
    ax = fig.add_subplot(111, projection='3d')
    ax.plot(coeff_hist[-4:,0],coeff_hist[-4:,1],coeff_hist[-4:,2],marker='o')
    plt.show()
