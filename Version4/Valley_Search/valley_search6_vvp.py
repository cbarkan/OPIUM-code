...
def valley_basis_find(level):
	...
	vv_log = open('valley_vector_log1.txt','a')
	vv_log.write('level = '+str(level))
	vv_log.write(np.array2string(V))
	vv_log.write('\n')
	vv_log.close()
...
vv_log = open('valley_vector_log1.txt','w')
vv_log.write(filename+'\n')
vv_log.write('alpha_step='+str(alpha_step)+'\n')
vv_log.write('local_orb='+str(local_orb)+'\n')
vv_log.write('a='+str(a)+'\n')
vv_log.write('b='+str(b)+'\n')
vv_log.write('timeout_sec='+str(timeout_sec)+'\n')
vv_log.write('slopeCheckAlpha='+str(slopeCheckAlpha)+'\n')
vv_log.write('resolution='+str(resolution)+'\n')
vv_log.write('x_min='+str(x_min)+'\n')
vv_log.write('x_max='+str(x_max)+'\n')
vv_log.close()
